...
class ResumeFacts(ResumeSchemaModel):
    facts: list[ResumeFactEx] = Field(default_factory=list, description="Flat list of extracted facts from the resume.")

class ResumeSections(ResumeSchemaModel):
    sections: list[ResumeSectionEx] = Field(default_factory=list, description="Flat list of extracted sections from the resume.")
