...
section_extraction_system_prompt = (
    ...
    "- Each section object MUST contain exactly section_id, title, and content.\n"
    "- section_id MUST be stable within this output, such as section_1, section_2, section_3.\n"
    "- Do NOT nest facts or any other child objects inside section rows.\n"
    "- Do NOT include extra fields.\n\n"
    "Extraction rules:\n"
...
facts_extraction_system_prompt = (
    ...
    "- Each fact object MUST contain exactly these flat fields: section_id, fact_type, text, evidence, keywords.\n"
    "- section_id MUST match the section_id value provided in the input section.\n"
    ...
    "- Do NOT nest section objects inside fact rows.\n"
    "- Do NOT include extra fields.\n"
