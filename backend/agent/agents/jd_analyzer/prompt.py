...
jd_extraction_system_prompt = (
    ...
    "job_title, job_level, job_family, primary_location, locations, remote_policy, "
    "employment_type, experience_raw, years_experience_min, years_experience_max, "
    "experience_level, education_raw, education_min, major_requirement, salary, benefits, blocks.\n"
    "- Do NOT output these forbidden top-level fields: title, location, experience, education, "
    "company, keywords, other_info.\n"
    "- For every block object, the block type field MUST be named block_type. Do NOT output type.\n\n"
    "Missing value rules:\n"
    "- For nullable string fields, use null when the information is missing.\n"
    "- For enum fields, NEVER use null. Use \"unknown\" when the information is missing or unclear.\n"
