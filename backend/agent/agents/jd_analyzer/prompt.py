...
jd_extraction_system_prompt = (
    ...
    "education_raw, education_min_rank, major_requirement, salary, benefits, blocks.\n"
    "- Do NOT output these forbidden top-level fields: title, location, experience, education, "
    "company, keywords, other_info, remote_policy, employment_type, experience_level, education_min.\n"
