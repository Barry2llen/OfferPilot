...
const zhCN = {
  ...
  chat: {
    ...
    interrupted: "已中断",
    error: "错误",
    contextCompacting: "正在整理上下文，请稍候...",
    contextCompacted: "上下文已压缩，后续对话将继续使用紧凑视图。",
    contextCompactionFailed: "上下文压缩失败，请重试。",
    newChat: "新对话",
    chatTitle: "AI 对话",
    newConversation: "新对话",
    searchHistory: "搜索历史...",
    ...
    webRead: "网页读取",
    analyzeResume: "简历分析",
    analyzeJobDescription: "岗位分析",
    analysisWorking: "分析处理中",
    analysisComplete: "分析完成",
    analysisFailed: "分析失败",
    analysisModelRetry: "模型重试",
    analysisError: "分析错误",
    openAnalysis: "查看分析详情",
    unknownTool: "未知工具",
...
const enUS = {
  ...
  chat: {
    ...
    analyzeJobDescription: "Job description analysis",
    analysisWorking: "Analysis in progress",
    analysisComplete: "Analysis complete",
    analysisFailed: "Analysis failed",
    analysisModelRetry: "Model retry",
    analysisError: "Analysis error",
    openAnalysis: "Open analysis details",
  ...
  settings: {
    title: "Settings",
    description: "Manage model connections, selections, and advanced behavior",
    tabsLabel: "Settings sections",
    modelConfigTab: "Model configuration",
