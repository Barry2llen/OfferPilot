...
```powershell
uv run python .codex/skills/sql-compat-validator/scripts/validate_sql_compat.py sql dev
```

Validate a specific file:

```powershell
uv run python .codex/skills/sql-compat-validator/scripts/validate_sql_compat.py sql/tables.sql
```
